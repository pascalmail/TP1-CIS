...
/* 
    These changes is added to make it so that this class can be referenced in
    other package.
    - Added a package statement.
    - Changed the class to public.

    Editor: Ismail Hassan <ismail.bukittinggi@gmail.com>
*/
